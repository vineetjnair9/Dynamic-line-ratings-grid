...
for date in pd.date_range(start='2016-6-1', end='2016-6-30', freq='D'):
    print(date, end=' ')
...
with open(r"C:\Users\vinee\OneDrive - Massachusetts Institute of Technology\MIT\Semesters\Spring 2022\15.S08\Project\weather_data_Jun2016.pkl", 'wb') as file:
