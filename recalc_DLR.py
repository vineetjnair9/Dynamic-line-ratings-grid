...
if personal:
    ...
    results_path = '/Users/vinee/Library/CloudStorage/OneDrive-MassachusettsInstituteofTechnology/MIT/Semesters/Spring 2022/15.S08/DLR Project/dlr_vals_notcapped'
else: # NREL laptop
    ...
    results_path = '/Users/vjagadee/OneDrive - Massachusetts Institute of Technology/MIT/Semesters/Spring 2022/15.S08/DLR Project/dlr_vals_notcapped'
            ...
            if k in hrs_for_each_date_indexed[global_d]:
                ...
                for l in range(num_branches):
                    ...
                    for m in range(num_unique):
                        ...
                        eta_low_v = alpha * math.sqrt(K_angle) * speed**0.26
                        eta_high_v = beta * math.sqrt(K_angle) * branch_diameters[l]**(0.04) * speed**0.3
...
with open(results_path + str3, 'wb') as file:
...
print('Case v2')
str3 = '_v2.pkl'
T_C_max = 100 # [C] more conservative
T_C_max = T_C_max + 273.15 # [K]
gamma = math.sqrt(1/(T_C_max - T_A_SLR))
            ...
            if k in hrs_for_each_date_indexed[global_d]:
                ...
                for l in range(num_branches):
                    ...
                    for m in range(num_unique):
                        ...
                        phi = wind_dir(u,v) - conductor_axes[l]
                        K_angle = 1.194 - math.cos(phi) + 0.194*math.cos(2*phi) + 0.368*math.sin(2*phi)
                        eta_low_v = alpha * math.sqrt(K_angle/0.388) * speed**0.26
                        eta_high_v = beta * math.sqrt(K_angle/0.388) * branch_diameters[l]**(0.04) * speed**0.3
                        eta_T = gamma*(T_C_max - temp)**0.5
                        # Not capped version: May be cases where DLR < SLR
                        dlrs[m] = max(eta_low_v*eta_T,eta_high_v*eta_T)
                        dlrs_wind[m] = max(eta_low_v,eta_high_v)
